...
Public Class CrysAdmissionList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payment_Account_Monitoring_System.CrysAdmissionList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysAdmissionList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysAdmissionList = New CrysAdmissionList()
        rpt.Site = Me.Site
        Return rpt
    End Function
