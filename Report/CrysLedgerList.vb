...
Public Class CrysLedgerList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payment_Account_Monitoring_System.CrysLedgerList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysLedgerList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysLedgerList = New CrysLedgerList()
        rpt.Site = Me.Site
        Return rpt
    End Function
