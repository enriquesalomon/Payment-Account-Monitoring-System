...
Public Class CrysPaymentList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payment_Account_Monitoring_System.CrysPaymentList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysPaymentList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysPaymentList = New CrysPaymentList()
        rpt.Site = Me.Site
        Return rpt
    End Function
