...
Public Class CrysSchoolFeesList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payment_Account_Monitoring_System.CrysSchoolFeesList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysSchoolFeesList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysSchoolFeesList = New CrysSchoolFeesList()
        rpt.Site = Me.Site
        Return rpt
    End Function
